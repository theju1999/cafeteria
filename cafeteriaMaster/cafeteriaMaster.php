			...
			<div id="wrap" style="background-color:#fff"> 
				<div id="page-heading" style="background-color:#fff">
					<ol class="breadcrumb">
						...
						<li class="active">Cafeteria Meal Type</li> 
					</ol>
					<br>
				</div>
				<div class="container">
									...
									<form action="" method="post" enctype="multipart/form-data" id="data">
										<div class="form-group row">
											<div class="col-md-3">
												...
												<input type="text" class="form-control" id="name" name="name"  placeholder="Type of Meal">
											</div>
											<div class="col-md-6">
										...
										<div align="center">
											<button class="btn btn-primary btn-label" type="button" onclick="saveForm()"><i class="fa fa-check"></i> Save</button>
										</div>				
									</div>
								</form>
							</div>	
...
<script type="text/javascript">
	...
	function saveForm()
	{
		...
		if(name=='')
		{
			$.pnotify({
				title: 'Name',
				text: 'Please enter the Meal Type',
				type: 'error'
			});
			return false;
		}
